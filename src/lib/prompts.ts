...
The app's diagnostic report format defined in this prompt SUPERSEDES any older reporting format inside the SEO skill — including the skill's "Required final report structure", the "Required finding format" with "Owner / Validation method", the "Top 5 priorities", "Recommended roadmap", and "Validation checklist" sections, and any use of "Priority P0–P3" as a fix queue.
