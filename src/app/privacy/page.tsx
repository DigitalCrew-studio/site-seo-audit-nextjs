...
export const metadata: Metadata = {
  ...
  description: `Как ${SITE_NAME} обрабатывает данные пользователей: что хранится локально, что отправляется на сервер, какие cookie и аналитика используются.`,
  alternates: {
  ...
  openGraph: {
    ...
    description: `Как ${SITE_NAME} обрабатывает данные пользователей.`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Политика конфиденциальности — ${SITE_NAME}`,
      },
    ],
  },
  twitter: {
    ...
    <main className="min-h-screen">
      <div className="paper-grid">
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <section className="mt-8 space-y-6 text-[14px] leading-relaxed text-ink-soft">
            <div>
