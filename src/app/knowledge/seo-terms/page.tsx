...
const PAGE_TITLE = "Словарь SEO-терминов — нормы и проверки";
const PAGE_DESCRIPTION =
  "Словарь Seofriendly по SEO-терминам: robots.txt, sitemap.xml, canonical, Core Web Vitals, Schema.org, GEO, llms.txt, GA4, SPF, DKIM, DMARC и другие понятия с нормами проверки.";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/knowledge/seo-terms`,
    languages: withHreflang("/knowledge/seo-terms"),
  },
  openGraph: {
    title: `Словарь SEO-терминов — ${SITE_NAME}`,
    description: PAGE_DESCRIPTION,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Словарь SEO-терминов — ${SITE_NAME}`,
      },
    ],
  },
  twitter: {
...
function buildKnowledgeStructuredData() {
  return {
    ...
    "@graph": [
      webPageSchema({
        path: "/knowledge/seo-terms",
        name: PAGE_TITLE,
        description: PAGE_DESCRIPTION,
      }),
      pageBreadcrumb("Словарь SEO-терминов", "/knowledge/seo-terms"),
      {
        "@type": "DefinedTermSet",
        "@id": `${SITE_URL}/knowledge/seo-terms#terms`,
        name: "Словарь SEO-терминов Seofriendly",
        inLanguage: "ru-RU",
        hasDefinedTerm: KNOWLEDGE_SECTIONS.flatMap((section) =>
          section.terms.map((item) => ({
            "@type": "DefinedTerm",
            "@id": `${SITE_URL}/knowledge/seo-terms#${getTermId(item.term)}`,
            url: `${SITE_URL}/knowledge/seo-terms#${getTermId(item.term)}`,
            name: item.term,
            description: item.meaning,
            termCode: item.term,
            inDefinedTermSet: `${SITE_URL}/knowledge/seo-terms#terms`,
          }))
        ),
      },
    ],
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
          <Breadcrumbs
            items={[
              ...
              { label: "Словарь SEO-терминов" },
            ]}
            className="mb-3"
          />
          <PageHeader
            title="Словарь SEO-терминов"
